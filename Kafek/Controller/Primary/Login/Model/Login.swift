...
struct Res_Login : Codable {
    ...
    let store_visibility_status: String?
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case store_visibility_status = "store_visibility_status"
    }
    ...
    init(from decoder: Decoder) throws {
        ...
        store_visibility_status = try values.decodeIfPresent(String.self, forKey: .store_visibility_status)
    }
