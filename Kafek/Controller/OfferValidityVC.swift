...
class OfferValidityVC: UIViewController {
...
extension OfferValidityVC: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        self.offerValidityHeight.constant = 10 * 165
        
        cell.cloOfferAccepted = {() in
